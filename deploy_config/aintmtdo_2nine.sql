...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2015 at 04:51 PM
...
CREATE TABLE `2nine_affiliate_activity` (
...
CREATE TABLE `2nine_affiliate_login` (
...
CREATE TABLE `2nine_affiliate_transaction` (
...
CREATE TABLE `2nine_attribute_description` (
  `attribute_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_attribute_group` (
  `attribute_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_banner_image` (
...
CREATE TABLE `2nine_banner_image_description` (
  `banner_image_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `banner_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_category_description` (
  `category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_category_filter` (
  `category_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_category_path` (
  `category_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_coupon_category` (
  `coupon_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_coupon_history` (
...
CREATE TABLE `2nine_coupon_product` (
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2015-12-10 16:50:43'),
(3, 'Euro', 'EUR', '', '€', '2', 0.91420001, 0, '2015-12-10 16:50:15'),
(4, 'VNĐ', 'VND', '', 'VNĐ', '', 22480.00000000, 1, '2015-12-10 16:50:15');
...
CREATE TABLE `2nine_customer_activity` (
  `activity_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `key` varchar(64) NOT NULL,
  `data` text NOT NULL,
...
CREATE TABLE `2nine_customer_ban_ip` (
...
CREATE TABLE `2nine_customer_group` (
  `customer_group_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_customer_history` (
...
CREATE TABLE `2nine_customer_ip` (
...
CREATE TABLE `2nine_customer_login` (
...
CREATE TABLE `2nine_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
CREATE TABLE `2nine_customer_reward` (
...
CREATE TABLE `2nine_customer_transaction` (
...
CREATE TABLE `2nine_custom_field` (
...
CREATE TABLE `2nine_custom_field_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_custom_field_value` (
...
CREATE TABLE `2nine_custom_field_value_description` (
  `custom_field_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
CREATE TABLE `2nine_download_description` (
  `download_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
...
CREATE TABLE `2nine_filter_group` (
  `filter_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_information` (
...
CREATE TABLE `2nine_information_description` (
  `information_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(64) NOT NULL,
  `description` text NOT NULL,
...
CREATE TABLE `2nine_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_layout_module` (
...
CREATE TABLE `2nine_layout_route` (
...
CREATE TABLE `2nine_length_class` (
...
CREATE TABLE `2nine_length_class_description` (
  `length_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
...
CREATE TABLE `2nine_manufacturer` (
...
CREATE TABLE `2nine_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_modification` (
...
CREATE TABLE `2nine_option_description` (
  `option_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_option_value` (
...
CREATE TABLE `2nine_option_value_description` (
  `option_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
CREATE TABLE `2nine_order_custom_field` (
...
CREATE TABLE `2nine_order_history` (
...
CREATE TABLE `2nine_order_option` (
...
CREATE TABLE `2nine_order_product` (
  `order_product_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
CREATE TABLE `2nine_order_recurring` (
...
CREATE TABLE `2nine_order_recurring_transaction` (
...
CREATE TABLE `2nine_order_status` (
  `order_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_order_total` (
...
CREATE TABLE `2nine_order_voucher` (
...
CREATE TABLE `2nine_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL
...
--
-- Dumping data for table `2nine_product_attribute`
--

INSERT INTO `2nine_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 4, 1, '16GB'),
(43, 4, 1, '8gb'),
(42, 3, 1, '100mhz'),
...
CREATE TABLE `2nine_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
CREATE TABLE `2nine_product_discount` (
...
--
-- Dumping data for table `2nine_product_discount`
--

INSERT INTO `2nine_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
CREATE TABLE `2nine_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_product_image` (
...
CREATE TABLE `2nine_product_option` (
  `product_option_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `value` text NOT NULL,
...
--
-- Dumping data for table `2nine_product_option`
--

INSERT INTO `2nine_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224, 35, 11, '', 1),
...
CREATE TABLE `2nine_product_option_value` (
...
--
-- Dumping data for table `2nine_product_option_value`
--

INSERT INTO `2nine_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
CREATE TABLE `2nine_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_product_related` (
  `product_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_product_reward` (
...
--
-- Dumping data for table `2nine_product_reward`
--

INSERT INTO `2nine_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515, 42, 1, 100),
(519, 47, 1, 300),
(379, 28, 1, 400),
(329, 43, 1, 600),
...
CREATE TABLE `2nine_product_special` (
...
--
-- Dumping data for table `2nine_product_special`
--

INSERT INTO `2nine_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
CREATE TABLE `2nine_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_return_action` (
  `return_action_id` int(11) NOT NULL,
...
CREATE TABLE `2nine_return_history` (
...
CREATE TABLE `2nine_return_reason` (
  `return_reason_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_return_status` (
  `return_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(506, 0, 'config', 'config_encryption', '57cbd4883ec076e8dafcffc79952843f', 0),
(505, 0, 'config', 'config_password', '1', 0),
(504, 0, 'config', 'config_maintenance', '0', 0),
(500, 0, 'config', 'config_seo_url', '0', 0),
(501, 0, 'config', 'config_file_max_size', '300000', 0),
(502, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(503, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
(94, 0, 'voucher', 'voucher_sort_order', '8', 0),
(95, 0, 'voucher', 'voucher_status', '1', 0),
(103, 0, 'free_checkout', 'free_checkout_status', '1', 0),
(104, 0, 'free_checkout', 'free_checkout_order_status_id', '1', 0),
(498, 0, 'config', 'config_shared', '0', 0),
(499, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(496, 0, 'config', 'config_mail_alert', '', 0),
(497, 0, 'config', 'config_secure', '0', 0),
(495, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
(494, 0, 'config', 'config_mail_smtp_port', '25', 0),
(493, 0, 'config', 'config_mail_smtp_password', '', 0),
(492, 0, 'config', 'config_mail_smtp_username', '', 0),
(491, 0, 'config', 'config_mail_smtp_hostname', '', 0),
(489, 0, 'config', 'config_mail_protocol', 'mail', 0),
(490, 0, 'config', 'config_mail_parameter', '', 0),
(488, 0, 'config', 'config_ftp_status', '0', 0),
(487, 0, 'config', 'config_ftp_root', '', 0),
(486, 0, 'config', 'config_ftp_password', '', 0),
(485, 0, 'config', 'config_ftp_username', '', 0),
(484, 0, 'config', 'config_ftp_port', '21', 0),
(483, 0, 'config', 'config_ftp_hostname', 'localhost', 0),
(482, 0, 'config', 'config_image_location_height', '50', 0),
(481, 0, 'config', 'config_image_location_width', '268', 0),
(480, 0, 'config', 'config_image_cart_height', '47', 0),
(479, 0, 'config', 'config_image_cart_width', '47', 0),
(478, 0, 'config', 'config_image_wishlist_height', '47', 0),
(477, 0, 'config', 'config_image_wishlist_width', '47', 0),
(476, 0, 'config', 'config_image_compare_height', '90', 0),
(475, 0, 'config', 'config_image_compare_width', '90', 0),
(474, 0, 'config', 'config_image_related_height', '80', 0),
(473, 0, 'config', 'config_image_related_width', '80', 0),
(471, 0, 'config', 'config_image_additional_width', '74', 0),
(472, 0, 'config', 'config_image_additional_height', '74', 0),
(470, 0, 'config', 'config_image_product_height', '228', 0),
(469, 0, 'config', 'config_image_product_width', '228', 0),
(468, 0, 'config', 'config_image_popup_height', '500', 0),
(466, 0, 'config', 'config_image_thumb_height', '228', 0),
(467, 0, 'config', 'config_image_popup_width', '500', 0),
(465, 0, 'config', 'config_image_thumb_width', '228', 0),
(464, 0, 'config', 'config_image_category_height', '80', 0),
(463, 0, 'config', 'config_image_category_width', '80', 0),
(462, 0, 'config', 'config_icon', 'catalog/cart.png', 0),
(461, 0, 'config', 'config_logo', 'catalog/logo.png', 0),
(460, 0, 'config', 'config_return_status_id', '2', 0),
(459, 0, 'config', 'config_return_id', '0', 0),
(458, 0, 'config', 'config_affiliate_mail', '0', 0),
(457, 0, 'config', 'config_affiliate_id', '4', 0),
(456, 0, 'config', 'config_affiliate_commission', '5', 0),
(455, 0, 'config', 'config_affiliate_auto', '0', 0),
(454, 0, 'config', 'config_affiliate_approval', '0', 0),
(453, 0, 'config', 'config_stock_checkout', '0', 0),
(452, 0, 'config', 'config_stock_warning', '0', 0),
(451, 0, 'config', 'config_stock_display', '0', 0),
(438, 0, 'config', 'config_customer_price', '0', 0),
(439, 0, 'config', 'config_login_attempts', '5', 0),
(440, 0, 'config', 'config_account_id', '3', 0),
(450, 0, 'config', 'config_order_mail', '0', 0),
(449, 0, 'config', 'config_complete_status', 'a:1:{i:0;s:1:"5";}', 1),
(448, 0, 'config', 'config_processing_status', 'a:1:{i:0;s:1:"2";}', 1),
(447, 0, 'config', 'config_order_status_id', '1', 0),
(446, 0, 'config', 'config_checkout_id', '5', 0),
(445, 0, 'config', 'config_checkout_guest', '1', 0),
(444, 0, 'config', 'config_cart_weight', '1', 0),
(443, 0, 'config', 'config_api_id', '1', 0),
(442, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(441, 0, 'config', 'config_account_mail', '0', 0),
(437, 0, 'config', 'config_customer_group_display', 'a:1:{i:0;s:1:"1";}', 1),
(436, 0, 'config', 'config_customer_group_id', '1', 0),
(435, 0, 'config', 'config_customer_online', '0', 0),
(434, 0, 'config', 'config_tax_customer', 'shipping', 0),
(433, 0, 'config', 'config_tax_default', 'shipping', 0),
(432, 0, 'config', 'config_tax', '1', 0),
(424, 0, 'config', 'config_product_limit', '15', 0),
(425, 0, 'config', 'config_product_description_length', '100', 0),
(426, 0, 'config', 'config_limit_admin', '20', 0),
(427, 0, 'config', 'config_review_status', '1', 0),
(428, 0, 'config', 'config_review_guest', '1', 0),
(429, 0, 'config', 'config_review_mail', '0', 0),
(430, 0, 'config', 'config_voucher_min', '1', 0),
(431, 0, 'config', 'config_voucher_max', '1000', 0),
(423, 0, 'config', 'config_product_count', '1', 0),
(422, 0, 'config', 'config_weight_class_id', '1', 0),
(419, 0, 'config', 'config_currency', 'VND', 0),
(420, 0, 'config', 'config_currency_auto', '1', 0),
(421, 0, 'config', 'config_length_class_id', '1', 0),
(409, 0, 'config', 'config_comment', '', 0),
(410, 0, 'config', 'config_meta_title', 'Shoes Store', 0),
(411, 0, 'config', 'config_meta_description', 'Shoes Store', 0),
(412, 0, 'config', 'config_meta_keyword', '', 0),
(413, 0, 'config', 'config_template', 'default', 0),
(414, 0, 'config', 'config_layout_id', '4', 0),
(415, 0, 'config', 'config_country_id', '222', 0),
(416, 0, 'config', 'config_zone_id', '3563', 0),
(417, 0, 'config', 'config_language', 'vi', 0),
(418, 0, 'config', 'config_admin_language', 'en', 0),
(408, 0, 'config', 'config_open', '', 0),
(407, 0, 'config', 'config_image', '', 0),
(406, 0, 'config', 'config_fax', '', 0),
(405, 0, 'config', 'config_telephone', '09 83 40 35 18', 0),
(404, 0, 'config', 'config_email', 'zabuza.vn@gmail.com', 0),
(403, 0, 'config', 'config_geocode', '', 0),
(402, 0, 'config', 'config_address', '209 Giap Nhat', 0),
(401, 0, 'config', 'config_owner', 'SHOES', 0),
(400, 0, 'config', 'config_name', '2NINE SHOP', 0),
(507, 0, 'config', 'config_compression', '0', 0),
(508, 0, 'config', 'config_error_display', '1', 0),
(509, 0, 'config', 'config_error_log', '1', 0),
(510, 0, 'config', 'config_error_filename', 'error.log', 0),
(511, 0, 'config', 'config_google_analytics', '', 0),
(512, 0, 'config', 'config_google_analytics_status', '0', 0),
(513, 0, 'config', 'config_google_captcha_public', '', 0),
(514, 0, 'config', 'config_google_captcha_secret', '', 0),
(515, 0, 'config', 'config_google_captcha_status', '0', 0);
...
CREATE TABLE `2nine_stock_status` (
  `stock_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(1, 1, 'admin', '2c424dfbe90ea2747d9479d5d74c4e1aff62b2cd', '4454df692', 'John', 'Doe', 'zabuza.vn@gmail.com', '', '', '::1', 1, '2015-12-10 17:37:38');
...
CREATE TABLE `2nine_voucher_history` (
...
CREATE TABLE `2nine_voucher_theme` (
  `voucher_theme_id` int(11) NOT NULL,
  `image` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `2nine_weight_class` (
...
CREATE TABLE `2nine_weight_class_description` (
  `weight_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `unit` varchar(4) NOT NULL
...
CREATE TABLE `2nine_zone_to_geo_zone` (
...
--
-- Indexes for table `2nine_address`
--
ALTER TABLE `2nine_address`
  ADD PRIMARY KEY (`address_id`),
  ADD KEY `customer_id` (`customer_id`);

--
-- Indexes for table `2nine_affiliate`
--
ALTER TABLE `2nine_affiliate`
  ADD PRIMARY KEY (`affiliate_id`);

--
-- Indexes for table `2nine_affiliate_activity`
--
ALTER TABLE `2nine_affiliate_activity`
  ADD PRIMARY KEY (`activity_id`);

--
-- Indexes for table `2nine_affiliate_login`
--
ALTER TABLE `2nine_affiliate_login`
  ADD PRIMARY KEY (`affiliate_login_id`),
  ADD KEY `email` (`email`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `2nine_affiliate_transaction`
--
ALTER TABLE `2nine_affiliate_transaction`
  ADD PRIMARY KEY (`affiliate_transaction_id`);

--
-- Indexes for table `2nine_api`
--
ALTER TABLE `2nine_api`
  ADD PRIMARY KEY (`api_id`);

--
-- Indexes for table `2nine_attribute`
--
ALTER TABLE `2nine_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Indexes for table `2nine_attribute_description`
--
ALTER TABLE `2nine_attribute_description`
  ADD PRIMARY KEY (`attribute_id`,`language_id`);

--
-- Indexes for table `2nine_attribute_group`
--
ALTER TABLE `2nine_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`);

--
-- Indexes for table `2nine_attribute_group_description`
--
ALTER TABLE `2nine_attribute_group_description`
  ADD PRIMARY KEY (`attribute_group_id`,`language_id`);

--
-- Indexes for table `2nine_banner`
--
ALTER TABLE `2nine_banner`
  ADD PRIMARY KEY (`banner_id`);

--
-- Indexes for table `2nine_banner_image`
--
ALTER TABLE `2nine_banner_image`
  ADD PRIMARY KEY (`banner_image_id`);

--
-- Indexes for table `2nine_banner_image_description`
--
ALTER TABLE `2nine_banner_image_description`
  ADD PRIMARY KEY (`banner_image_id`,`language_id`);

--
-- Indexes for table `2nine_category`
--
ALTER TABLE `2nine_category`
  ADD PRIMARY KEY (`category_id`),
  ADD KEY `parent_id` (`parent_id`);

--
-- Indexes for table `2nine_category_description`
--
ALTER TABLE `2nine_category_description`
  ADD PRIMARY KEY (`category_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `2nine_category_filter`
--
ALTER TABLE `2nine_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- Indexes for table `2nine_category_path`
--
ALTER TABLE `2nine_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- Indexes for table `2nine_category_to_layout`
--
ALTER TABLE `2nine_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `2nine_category_to_store`
--
ALTER TABLE `2nine_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `2nine_country`
--
ALTER TABLE `2nine_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Indexes for table `2nine_coupon`
--
ALTER TABLE `2nine_coupon`
  ADD PRIMARY KEY (`coupon_id`);

--
-- Indexes for table `2nine_coupon_category`
--
ALTER TABLE `2nine_coupon_category`
  ADD PRIMARY KEY (`coupon_id`,`category_id`);

--
-- Indexes for table `2nine_coupon_history`
--
ALTER TABLE `2nine_coupon_history`
  ADD PRIMARY KEY (`coupon_history_id`);

--
-- Indexes for table `2nine_coupon_product`
--
ALTER TABLE `2nine_coupon_product`
  ADD PRIMARY KEY (`coupon_product_id`);

--
-- Indexes for table `2nine_currency`
--
ALTER TABLE `2nine_currency`
  ADD PRIMARY KEY (`currency_id`);

--
-- Indexes for table `2nine_customer`
--
ALTER TABLE `2nine_customer`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `2nine_customer_activity`
--
ALTER TABLE `2nine_customer_activity`
  ADD PRIMARY KEY (`activity_id`);

--
-- Indexes for table `2nine_customer_ban_ip`
--
ALTER TABLE `2nine_customer_ban_ip`
  ADD PRIMARY KEY (`customer_ban_ip_id`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `2nine_customer_group`
--
ALTER TABLE `2nine_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- Indexes for table `2nine_customer_group_description`
--
ALTER TABLE `2nine_customer_group_description`
  ADD PRIMARY KEY (`customer_group_id`,`language_id`);

--
-- Indexes for table `2nine_customer_history`
--
ALTER TABLE `2nine_customer_history`
  ADD PRIMARY KEY (`customer_history_id`);

--
-- Indexes for table `2nine_customer_ip`
--
ALTER TABLE `2nine_customer_ip`
  ADD PRIMARY KEY (`customer_ip_id`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `2nine_customer_login`
--
ALTER TABLE `2nine_customer_login`
  ADD PRIMARY KEY (`customer_login_id`),
  ADD KEY `email` (`email`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `2nine_customer_online`
--
ALTER TABLE `2nine_customer_online`
  ADD PRIMARY KEY (`ip`);

--
-- Indexes for table `2nine_customer_reward`
--
ALTER TABLE `2nine_customer_reward`
  ADD PRIMARY KEY (`customer_reward_id`);

--
-- Indexes for table `2nine_customer_transaction`
--
ALTER TABLE `2nine_customer_transaction`
  ADD PRIMARY KEY (`customer_transaction_id`);

--
-- Indexes for table `2nine_custom_field`
--
ALTER TABLE `2nine_custom_field`
  ADD PRIMARY KEY (`custom_field_id`);

--
-- Indexes for table `2nine_custom_field_customer_group`
--
ALTER TABLE `2nine_custom_field_customer_group`
  ADD PRIMARY KEY (`custom_field_id`,`customer_group_id`);

--
-- Indexes for table `2nine_custom_field_description`
--
ALTER TABLE `2nine_custom_field_description`
  ADD PRIMARY KEY (`custom_field_id`,`language_id`);

--
-- Indexes for table `2nine_custom_field_value`
--
ALTER TABLE `2nine_custom_field_value`
  ADD PRIMARY KEY (`custom_field_value_id`);

--
-- Indexes for table `2nine_custom_field_value_description`
--
ALTER TABLE `2nine_custom_field_value_description`
  ADD PRIMARY KEY (`custom_field_value_id`,`language_id`);

--
-- Indexes for table `2nine_download`
--
ALTER TABLE `2nine_download`
  ADD PRIMARY KEY (`download_id`);

--
-- Indexes for table `2nine_download_description`
--
ALTER TABLE `2nine_download_description`
  ADD PRIMARY KEY (`download_id`,`language_id`);

--
-- Indexes for table `2nine_event`
--
ALTER TABLE `2nine_event`
  ADD PRIMARY KEY (`event_id`);

--
-- Indexes for table `2nine_extension`
--
ALTER TABLE `2nine_extension`
  ADD PRIMARY KEY (`extension_id`);

--
-- Indexes for table `2nine_filter`
--
ALTER TABLE `2nine_filter`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `2nine_filter_description`
--
ALTER TABLE `2nine_filter_description`
  ADD PRIMARY KEY (`filter_id`,`language_id`);

--
-- Indexes for table `2nine_filter_group`
--
ALTER TABLE `2nine_filter_group`
  ADD PRIMARY KEY (`filter_group_id`);

--
-- Indexes for table `2nine_filter_group_description`
--
ALTER TABLE `2nine_filter_group_description`
  ADD PRIMARY KEY (`filter_group_id`,`language_id`);

--
-- Indexes for table `2nine_geo_zone`
--
ALTER TABLE `2nine_geo_zone`
  ADD PRIMARY KEY (`geo_zone_id`);

--
-- Indexes for table `2nine_information`
--
ALTER TABLE `2nine_information`
  ADD PRIMARY KEY (`information_id`);

--
-- Indexes for table `2nine_information_description`
--
ALTER TABLE `2nine_information_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- Indexes for table `2nine_information_to_layout`
--
ALTER TABLE `2nine_information_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `2nine_information_to_store`
--
ALTER TABLE `2nine_information_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `2nine_language`
--
ALTER TABLE `2nine_language`
  ADD PRIMARY KEY (`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `2nine_layout`
--
ALTER TABLE `2nine_layout`
  ADD PRIMARY KEY (`layout_id`);

--
-- Indexes for table `2nine_layout_module`
--
ALTER TABLE `2nine_layout_module`
  ADD PRIMARY KEY (`layout_module_id`);

--
-- Indexes for table `2nine_layout_route`
--
ALTER TABLE `2nine_layout_route`
  ADD PRIMARY KEY (`layout_route_id`);

--
-- Indexes for table `2nine_length_class`
--
ALTER TABLE `2nine_length_class`
  ADD PRIMARY KEY (`length_class_id`);

--
-- Indexes for table `2nine_length_class_description`
--
ALTER TABLE `2nine_length_class_description`
  ADD PRIMARY KEY (`length_class_id`,`language_id`);

--
-- Indexes for table `2nine_location`
--
ALTER TABLE `2nine_location`
  ADD PRIMARY KEY (`location_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `2nine_manufacturer`
--
ALTER TABLE `2nine_manufacturer`
  ADD PRIMARY KEY (`manufacturer_id`);

--
-- Indexes for table `2nine_manufacturer_to_store`
--
ALTER TABLE `2nine_manufacturer_to_store`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indexes for table `2nine_marketing`
--
ALTER TABLE `2nine_marketing`
  ADD PRIMARY KEY (`marketing_id`);

--
-- Indexes for table `2nine_modification`
--
ALTER TABLE `2nine_modification`
  ADD PRIMARY KEY (`modification_id`);

--
-- Indexes for table `2nine_module`
--
ALTER TABLE `2nine_module`
  ADD PRIMARY KEY (`module_id`);

--
-- Indexes for table `2nine_option`
--
ALTER TABLE `2nine_option`
  ADD PRIMARY KEY (`option_id`);

--
-- Indexes for table `2nine_option_description`
--
ALTER TABLE `2nine_option_description`
  ADD PRIMARY KEY (`option_id`,`language_id`);

--
-- Indexes for table `2nine_option_value`
--
ALTER TABLE `2nine_option_value`
  ADD PRIMARY KEY (`option_value_id`);

--
-- Indexes for table `2nine_option_value_description`
--
ALTER TABLE `2nine_option_value_description`
  ADD PRIMARY KEY (`option_value_id`,`language_id`);

--
-- Indexes for table `2nine_order`
--
ALTER TABLE `2nine_order`
  ADD PRIMARY KEY (`order_id`);

--
-- Indexes for table `2nine_order_custom_field`
--
ALTER TABLE `2nine_order_custom_field`
  ADD PRIMARY KEY (`order_custom_field_id`);

--
-- Indexes for table `2nine_order_history`
--
ALTER TABLE `2nine_order_history`
  ADD PRIMARY KEY (`order_history_id`);

--
-- Indexes for table `2nine_order_option`
--
ALTER TABLE `2nine_order_option`
  ADD PRIMARY KEY (`order_option_id`);

--
-- Indexes for table `2nine_order_product`
--
ALTER TABLE `2nine_order_product`
  ADD PRIMARY KEY (`order_product_id`);

--
-- Indexes for table `2nine_order_recurring`
--
ALTER TABLE `2nine_order_recurring`
  ADD PRIMARY KEY (`order_recurring_id`);

--
-- Indexes for table `2nine_order_recurring_transaction`
--
ALTER TABLE `2nine_order_recurring_transaction`
  ADD PRIMARY KEY (`order_recurring_transaction_id`);

--
-- Indexes for table `2nine_order_status`
--
ALTER TABLE `2nine_order_status`
  ADD PRIMARY KEY (`order_status_id`,`language_id`);

--
-- Indexes for table `2nine_order_total`
--
ALTER TABLE `2nine_order_total`
  ADD PRIMARY KEY (`order_total_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `2nine_order_voucher`
--
ALTER TABLE `2nine_order_voucher`
  ADD PRIMARY KEY (`order_voucher_id`);

--
-- Indexes for table `2nine_product`
--
ALTER TABLE `2nine_product`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `2nine_product_attribute`
--
ALTER TABLE `2nine_product_attribute`
  ADD PRIMARY KEY (`product_id`,`attribute_id`,`language_id`);

--
-- Indexes for table `2nine_product_description`
--
ALTER TABLE `2nine_product_description`
  ADD PRIMARY KEY (`product_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `2nine_product_discount`
--
ALTER TABLE `2nine_product_discount`
  ADD PRIMARY KEY (`product_discount_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `2nine_product_filter`
--
ALTER TABLE `2nine_product_filter`
  ADD PRIMARY KEY (`product_id`,`filter_id`);

--
-- Indexes for table `2nine_product_image`
--
ALTER TABLE `2nine_product_image`
  ADD PRIMARY KEY (`product_image_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `2nine_product_option`
--
ALTER TABLE `2nine_product_option`
  ADD PRIMARY KEY (`product_option_id`);

--
-- Indexes for table `2nine_product_option_value`
--
ALTER TABLE `2nine_product_option_value`
  ADD PRIMARY KEY (`product_option_value_id`);

--
-- Indexes for table `2nine_product_recurring`
--
ALTER TABLE `2nine_product_recurring`
  ADD PRIMARY KEY (`product_id`,`recurring_id`,`customer_group_id`);

--
-- Indexes for table `2nine_product_related`
--
ALTER TABLE `2nine_product_related`
  ADD PRIMARY KEY (`product_id`,`related_id`);

--
-- Indexes for table `2nine_product_reward`
--
ALTER TABLE `2nine_product_reward`
  ADD PRIMARY KEY (`product_reward_id`);

--
-- Indexes for table `2nine_product_special`
--
ALTER TABLE `2nine_product_special`
  ADD PRIMARY KEY (`product_special_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `2nine_product_to_category`
--
ALTER TABLE `2nine_product_to_category`
  ADD PRIMARY KEY (`product_id`,`category_id`),
  ADD KEY `category_id` (`category_id`);

--
-- Indexes for table `2nine_product_to_download`
--
ALTER TABLE `2nine_product_to_download`
  ADD PRIMARY KEY (`product_id`,`download_id`);

--
-- Indexes for table `2nine_product_to_layout`
--
ALTER TABLE `2nine_product_to_layout`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `2nine_product_to_store`
--
ALTER TABLE `2nine_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `2nine_recurring`
--
ALTER TABLE `2nine_recurring`
  ADD PRIMARY KEY (`recurring_id`);

--
-- Indexes for table `2nine_recurring_description`
--
ALTER TABLE `2nine_recurring_description`
  ADD PRIMARY KEY (`recurring_id`,`language_id`);

--
-- Indexes for table `2nine_return`
--
ALTER TABLE `2nine_return`
  ADD PRIMARY KEY (`return_id`);

--
-- Indexes for table `2nine_return_action`
--
ALTER TABLE `2nine_return_action`
  ADD PRIMARY KEY (`return_action_id`,`language_id`);

--
-- Indexes for table `2nine_return_history`
--
ALTER TABLE `2nine_return_history`
  ADD PRIMARY KEY (`return_history_id`);

--
-- Indexes for table `2nine_return_reason`
--
ALTER TABLE `2nine_return_reason`
  ADD PRIMARY KEY (`return_reason_id`,`language_id`);

--
-- Indexes for table `2nine_return_status`
--
ALTER TABLE `2nine_return_status`
  ADD PRIMARY KEY (`return_status_id`,`language_id`);

--
-- Indexes for table `2nine_review`
--
ALTER TABLE `2nine_review`
  ADD PRIMARY KEY (`review_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `2nine_setting`
--
ALTER TABLE `2nine_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Indexes for table `2nine_stock_status`
--
ALTER TABLE `2nine_stock_status`
  ADD PRIMARY KEY (`stock_status_id`,`language_id`);

--
-- Indexes for table `2nine_store`
--
ALTER TABLE `2nine_store`
  ADD PRIMARY KEY (`store_id`);

--
-- Indexes for table `2nine_tax_class`
--
ALTER TABLE `2nine_tax_class`
  ADD PRIMARY KEY (`tax_class_id`);

--
-- Indexes for table `2nine_tax_rate`
--
ALTER TABLE `2nine_tax_rate`
  ADD PRIMARY KEY (`tax_rate_id`);

--
-- Indexes for table `2nine_tax_rate_to_customer_group`
--
ALTER TABLE `2nine_tax_rate_to_customer_group`
  ADD PRIMARY KEY (`tax_rate_id`,`customer_group_id`);

--
-- Indexes for table `2nine_tax_rule`
--
ALTER TABLE `2nine_tax_rule`
  ADD PRIMARY KEY (`tax_rule_id`);

--
-- Indexes for table `2nine_upload`
--
ALTER TABLE `2nine_upload`
  ADD PRIMARY KEY (`upload_id`);

--
-- Indexes for table `2nine_url_alias`
--
ALTER TABLE `2nine_url_alias`
  ADD PRIMARY KEY (`url_alias_id`),
  ADD KEY `query` (`query`),
  ADD KEY `keyword` (`keyword`);

--
-- Indexes for table `2nine_user`
--
ALTER TABLE `2nine_user`
  ADD PRIMARY KEY (`user_id`);

--
-- Indexes for table `2nine_user_group`
--
ALTER TABLE `2nine_user_group`
  ADD PRIMARY KEY (`user_group_id`);

--
-- Indexes for table `2nine_voucher`
--
ALTER TABLE `2nine_voucher`
  ADD PRIMARY KEY (`voucher_id`);

--
-- Indexes for table `2nine_voucher_history`
--
ALTER TABLE `2nine_voucher_history`
  ADD PRIMARY KEY (`voucher_history_id`);

--
-- Indexes for table `2nine_voucher_theme`
--
ALTER TABLE `2nine_voucher_theme`
  ADD PRIMARY KEY (`voucher_theme_id`);

--
-- Indexes for table `2nine_voucher_theme_description`
--
ALTER TABLE `2nine_voucher_theme_description`
  ADD PRIMARY KEY (`voucher_theme_id`,`language_id`);

--
-- Indexes for table `2nine_weight_class`
--
ALTER TABLE `2nine_weight_class`
  ADD PRIMARY KEY (`weight_class_id`);

--
-- Indexes for table `2nine_weight_class_description`
--
ALTER TABLE `2nine_weight_class_description`
  ADD PRIMARY KEY (`weight_class_id`,`language_id`);

--
-- Indexes for table `2nine_zone`
--
ALTER TABLE `2nine_zone`
  ADD PRIMARY KEY (`zone_id`);

--
-- Indexes for table `2nine_zone_to_geo_zone`
--
ALTER TABLE `2nine_zone_to_geo_zone`
...
--
-- AUTO_INCREMENT for table `2nine_address`
--
ALTER TABLE `2nine_address`
  MODIFY `address_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_affiliate`
--
ALTER TABLE `2nine_affiliate`
  MODIFY `affiliate_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_affiliate_activity`
--
ALTER TABLE `2nine_affiliate_activity`
  MODIFY `activity_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_affiliate_login`
--
ALTER TABLE `2nine_affiliate_login`
  MODIFY `affiliate_login_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_affiliate_transaction`
--
ALTER TABLE `2nine_affiliate_transaction`
  MODIFY `affiliate_transaction_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_api`
--
ALTER TABLE `2nine_api`
  MODIFY `api_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `2nine_attribute`
--
ALTER TABLE `2nine_attribute`
  MODIFY `attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `2nine_attribute_group`
--
ALTER TABLE `2nine_attribute_group`
  MODIFY `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `2nine_banner`
--
ALTER TABLE `2nine_banner`
  MODIFY `banner_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `2nine_banner_image`
--
ALTER TABLE `2nine_banner_image`
  MODIFY `banner_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
--
-- AUTO_INCREMENT for table `2nine_category`
--
ALTER TABLE `2nine_category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
--
-- AUTO_INCREMENT for table `2nine_country`
--
ALTER TABLE `2nine_country`
  MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;
--
-- AUTO_INCREMENT for table `2nine_coupon`
--
ALTER TABLE `2nine_coupon`
  MODIFY `coupon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `2nine_coupon_history`
--
ALTER TABLE `2nine_coupon_history`
  MODIFY `coupon_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_coupon_product`
--
ALTER TABLE `2nine_coupon_product`
  MODIFY `coupon_product_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_currency`
--
ALTER TABLE `2nine_currency`
  MODIFY `currency_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `2nine_customer`
--
ALTER TABLE `2nine_customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_customer_activity`
--
ALTER TABLE `2nine_customer_activity`
  MODIFY `activity_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_customer_ban_ip`
--
ALTER TABLE `2nine_customer_ban_ip`
  MODIFY `customer_ban_ip_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_customer_group`
--
ALTER TABLE `2nine_customer_group`
  MODIFY `customer_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `2nine_customer_history`
--
ALTER TABLE `2nine_customer_history`
  MODIFY `customer_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_customer_ip`
--
ALTER TABLE `2nine_customer_ip`
  MODIFY `customer_ip_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_customer_login`
--
ALTER TABLE `2nine_customer_login`
  MODIFY `customer_login_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_customer_reward`
--
ALTER TABLE `2nine_customer_reward`
  MODIFY `customer_reward_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_customer_transaction`
--
ALTER TABLE `2nine_customer_transaction`
  MODIFY `customer_transaction_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_custom_field`
--
ALTER TABLE `2nine_custom_field`
  MODIFY `custom_field_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_custom_field_value`
--
ALTER TABLE `2nine_custom_field_value`
  MODIFY `custom_field_value_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_download`
--
ALTER TABLE `2nine_download`
  MODIFY `download_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_event`
--
ALTER TABLE `2nine_event`
  MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_extension`
--
ALTER TABLE `2nine_extension`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=428;
--
-- AUTO_INCREMENT for table `2nine_filter`
--
ALTER TABLE `2nine_filter`
  MODIFY `filter_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_filter_group`
--
ALTER TABLE `2nine_filter_group`
  MODIFY `filter_group_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_geo_zone`
--
ALTER TABLE `2nine_geo_zone`
  MODIFY `geo_zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `2nine_information`
--
ALTER TABLE `2nine_information`
  MODIFY `information_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `2nine_language`
--
ALTER TABLE `2nine_language`
  MODIFY `language_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `2nine_layout`
--
ALTER TABLE `2nine_layout`
  MODIFY `layout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `2nine_layout_module`
--
ALTER TABLE `2nine_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
--
-- AUTO_INCREMENT for table `2nine_layout_route`
--
ALTER TABLE `2nine_layout_route`
  MODIFY `layout_route_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT for table `2nine_length_class`
--
ALTER TABLE `2nine_length_class`
  MODIFY `length_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `2nine_length_class_description`
--
ALTER TABLE `2nine_length_class_description`
  MODIFY `length_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `2nine_location`
--
ALTER TABLE `2nine_location`
  MODIFY `location_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_manufacturer`
--
ALTER TABLE `2nine_manufacturer`
  MODIFY `manufacturer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `2nine_marketing`
--
ALTER TABLE `2nine_marketing`
  MODIFY `marketing_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_modification`
--
ALTER TABLE `2nine_modification`
  MODIFY `modification_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_module`
--
ALTER TABLE `2nine_module`
  MODIFY `module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT for table `2nine_option`
--
ALTER TABLE `2nine_option`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `2nine_option_value`
--
ALTER TABLE `2nine_option_value`
  MODIFY `option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT for table `2nine_order`
--
ALTER TABLE `2nine_order`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_order_custom_field`
--
ALTER TABLE `2nine_order_custom_field`
  MODIFY `order_custom_field_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_order_history`
--
ALTER TABLE `2nine_order_history`
  MODIFY `order_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_order_option`
--
ALTER TABLE `2nine_order_option`
  MODIFY `order_option_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_order_product`
--
ALTER TABLE `2nine_order_product`
  MODIFY `order_product_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_order_recurring`
--
ALTER TABLE `2nine_order_recurring`
  MODIFY `order_recurring_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_order_recurring_transaction`
--
ALTER TABLE `2nine_order_recurring_transaction`
  MODIFY `order_recurring_transaction_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_order_status`
--
ALTER TABLE `2nine_order_status`
  MODIFY `order_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `2nine_order_total`
--
ALTER TABLE `2nine_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_order_voucher`
--
ALTER TABLE `2nine_order_voucher`
  MODIFY `order_voucher_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_product`
--
ALTER TABLE `2nine_product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
--
-- AUTO_INCREMENT for table `2nine_product_discount`
--
ALTER TABLE `2nine_product_discount`
  MODIFY `product_discount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=441;
--
-- AUTO_INCREMENT for table `2nine_product_image`
--
ALTER TABLE `2nine_product_image`
  MODIFY `product_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2352;
--
-- AUTO_INCREMENT for table `2nine_product_option`
--
ALTER TABLE `2nine_product_option`
  MODIFY `product_option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;
--
-- AUTO_INCREMENT for table `2nine_product_option_value`
--
ALTER TABLE `2nine_product_option_value`
  MODIFY `product_option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `2nine_product_reward`
--
ALTER TABLE `2nine_product_reward`
  MODIFY `product_reward_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=546;
--
-- AUTO_INCREMENT for table `2nine_product_special`
--
ALTER TABLE `2nine_product_special`
  MODIFY `product_special_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=440;
--
-- AUTO_INCREMENT for table `2nine_recurring`
--
ALTER TABLE `2nine_recurring`
  MODIFY `recurring_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_return`
--
ALTER TABLE `2nine_return`
  MODIFY `return_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_return_action`
--
ALTER TABLE `2nine_return_action`
  MODIFY `return_action_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `2nine_return_history`
--
ALTER TABLE `2nine_return_history`
  MODIFY `return_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_return_reason`
--
ALTER TABLE `2nine_return_reason`
  MODIFY `return_reason_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `2nine_return_status`
--
ALTER TABLE `2nine_return_status`
  MODIFY `return_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `2nine_review`
--
ALTER TABLE `2nine_review`
  MODIFY `review_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_setting`
--
ALTER TABLE `2nine_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=516;
--
-- AUTO_INCREMENT for table `2nine_stock_status`
--
ALTER TABLE `2nine_stock_status`
  MODIFY `stock_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `2nine_store`
--
ALTER TABLE `2nine_store`
  MODIFY `store_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_tax_class`
--
ALTER TABLE `2nine_tax_class`
  MODIFY `tax_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `2nine_tax_rate`
--
ALTER TABLE `2nine_tax_rate`
  MODIFY `tax_rate_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
--
-- AUTO_INCREMENT for table `2nine_tax_rule`
--
ALTER TABLE `2nine_tax_rule`
  MODIFY `tax_rule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
--
-- AUTO_INCREMENT for table `2nine_upload`
--
ALTER TABLE `2nine_upload`
  MODIFY `upload_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_url_alias`
--
ALTER TABLE `2nine_url_alias`
  MODIFY `url_alias_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=844;
--
-- AUTO_INCREMENT for table `2nine_user`
--
ALTER TABLE `2nine_user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `2nine_user_group`
--
ALTER TABLE `2nine_user_group`
  MODIFY `user_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `2nine_voucher`
--
ALTER TABLE `2nine_voucher`
  MODIFY `voucher_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_voucher_history`
--
ALTER TABLE `2nine_voucher_history`
  MODIFY `voucher_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `2nine_voucher_theme`
--
ALTER TABLE `2nine_voucher_theme`
  MODIFY `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `2nine_weight_class`
--
ALTER TABLE `2nine_weight_class`
  MODIFY `weight_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `2nine_weight_class_description`
--
ALTER TABLE `2nine_weight_class_description`
  MODIFY `weight_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `2nine_zone`
--
ALTER TABLE `2nine_zone`
  MODIFY `zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4231;
--
-- AUTO_INCREMENT for table `2nine_zone_to_geo_zone`
--
ALTER TABLE `2nine_zone_to_geo_zone`
